...
public class F03_MD_ArrayToplama {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nIlk halini yazdirmis olsa idik");
        System.out.println("Direkt yazdirma : " +Arrays.toString(arr));
        System.out.println("Icini yazdirma : "+Arrays.deepToString(arr));
